...
def test_honing_projectile_creation():
    ...
    projectile = Projectile(pos=pygame.math.Vector2(100, 100), attack_damage=1, source='player', target=target)
...
def test_skill_shot_projectile_creation():
    ...
    projectile = Projectile(pos=pygame.math.Vector2(100, 100), attack_damage=1, source='player', direction=direction)
...
def test_projectile_update_honing():
    ...
    projectile = Projectile(pos=pygame.math.Vector2(0, 0), attack_damage=1, source='player', target=target, speed=5)
...
def test_projectile_update_skill_shot():
    ...
    direction = pygame.math.Vector2(1, 0)
    projectile = Projectile(pos=pygame.math.Vector2(0, 0), attack_damage=1, source='player', direction=direction, speed=5)
